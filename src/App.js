...
class App extends React.Component {
  ...
  _search() {
    ...
    console.log(text);
    fetch('http://ec2-18-222-31-66.us-east-2.compute.amazonaws.com:8983/solr/norconex/select?q=title:' + text + '^3 description:' + text + '^2 content:' + text + "&hl.fl=title description&hl.simple.post=</span>&hl.simple.pre=<span style=\"font-weight:bold\">&hl=on")
      .then(res => res.json())
      .then((result) => {
